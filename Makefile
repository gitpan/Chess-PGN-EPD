# This Makefile is for the Chess::PGN::EPD extension to perl.
#
...
#	ABSTRACT_FROM => q[EPD.pm]
#	AUTHOR => q[Hugh S. Myers <hsmyers@sdragons.com>]
#	NAME => q[Chess::PGN::EPD]
#	PREREQ_PM => {  }
#	VERSION_FROM => q[EPD.pm]
...
FULLEXT = Chess\PGN\EPD
BASEEXT = EPD
PARENT_NAME = Chess::PGN
DLBASE = $(BASEEXT)
VERSION_FROM = EPD.pm
OBJECT = 
LDFROM = $(OBJECT)
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)\Chess\PGN
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\Chess\PGN
...
DB_FILES=db\ECO db\NIC db\Opening
...
EPD.def: Makefile.PL
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME' => 'Chess::PGN::EPD', 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f  $(INST_LIBDIR)\EPD.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Chess-PGN-EPD\" VERSION=\"0,06,0,0\">\n}. qq{\t<TITLE>Chess-PGN-EPD</TITLE>\n}. qq{\t<ABSTRACT>Perl extension to produce and manipulate EPD text.</ABSTRACT>\n}. qq{\t<AUTHOR>Hugh S. Myers &lt;hsmyers\@sdragons.com&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Chess-PGN-EPD.ppd
